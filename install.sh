...
cd /usr/bin
wget -q -O encryptall "${link}shco.sh"
wget -q -O enc "${link}menuenc.sh"
wget -q -O downloadenc "${link}downloadenc.sh"
wget -q -O executor "${link}executor.sh"
wget -q -O lcnsmenu "${link}lcnsmenu.sh"
sleep 1
clear
chmod +x encryptall
chmod +x enc
