...
# Link Instalasi
link="https://github.com/sekencois/panel/main/izin"
...
cd /usr/bin
wget -q -O encryptall "https://github.com/sekencois/panel/main/shco.sh"
wget -q -O enc "https://github.com/sekencois/panel/main/menuenc.sh"
wget -q -O downloadenc "https://github.com/sekencois/panel/main/downloadenc.sh"
wget -q -O executor "https://github.com/sekencois/panel/main/executor.sh"
wget -q -O lcnsmenu "https://github.com/sekencois/panel/main/lcnsmenu.sh"
sleep 1
clear
chmod +x encryptall
chmod +x enc
